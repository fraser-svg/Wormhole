...
- [x] **Completed: v0.3.0.0 (2026-04-09)** Auto-detect init suggestion (cd into repo → suggest init)
- [ ] **Priority: P2** One-line installer (curl | sh) with service registration (launchd/systemd)
- [ ] **Priority: P2** Menubar / system tray indicator (macOS: menubar icon showing active projects)
...
- [x] **Completed: v0.3.0.0 (2026-04-09)** User-level config (~/.wormhole/config.yaml) with merge semantics
- [ ] **Priority: P3** Content validation / prompt injection detection for team vaults

## Completed

- [x] **Completed: v0.3.0.0 (2026-04-09)** Background daemon (`wormhole up`/`wormhole down`) with multi-project watching
- [x] **Completed: v0.3.0.0 (2026-04-09)** Auto-init on project detection from `~/.claude/projects/`
- [x] **Completed: v0.3.0.0 (2026-04-09)** MCP server for live vault queries from Claude Code
- [x] **Completed: v0.3.0.0 (2026-04-09)** Global config (~/.wormhole/config.yaml) with merge semantics
- [x] **Completed: v0.3.0.0 (2026-04-09)** Project registry with persistent tracking
